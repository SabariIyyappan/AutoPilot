...
// The diagnosis pipeline is generated by packages/adapter/llm-diagnoser.ts at
// runtime; pipelines/diagnosis.pipe is a committed snapshot so it can be opened
// on the RocketRide canvas during the demo.
const files = {
